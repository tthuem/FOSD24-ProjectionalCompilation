...
\subsection{Deterministic Decomposable Negation Normal Form (d-DNNF)}
\begin{frame}{\insertsubsection}
	\begin{columns}[]
...
\subsection{Slicing Implementation}
\begin{frame}{\insertsubsection\footnote{Comparing Algorithms for Efficient Feature-Model Slicing, Krieter et al.}}
