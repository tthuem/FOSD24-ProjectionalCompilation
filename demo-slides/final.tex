...
\begin{frame}{\insertsubsection}
	\pic[width=\linewidth,trim={0\width} {.4\height} {0\width} {.2\height},clip,page=10]{pD4}
\end{frame}
\begin{frame}{\insertsubsection}
	\pic[width=\linewidth,trim={0\width} {.4\height} {0\width} {.2\height},clip,page=11]{pD4}
\end{frame}
\begin{frame}{\insertsubsection}
	\pic[width=\linewidth,trim={0\width} {.4\height} {0\width} {.2\height},clip,page=12]{pD4}
\end{frame}
...
\begin{frame}{\insertsubsection\hfill{}Projection + Compilation = Projected Compilation}
	\pic[width=\linewidth,trim={0\width} {.4\height} {0\width} {.2\height},clip,page=13]{pD4}
\end{frame}
